...
//    protected WriteThread write;
    ...
    public static abstract class ConnectorBuilderAbstract<C extends ConnectorOld, B extends ConnectorBuilderAbstract<C, B>>
            extends Builder<C, B> {
        protected OutputStream out;
        protected InputStream in;
    ...
    public static class ConnectorBuilder extends ConnectorBuilderAbstract<ConnectorOld, ConnectorBuilder> {
        @Override
        ...
        @Override
        public ConnectorOld instance() {
            return new ConnectorOld();
        }
    }
}
